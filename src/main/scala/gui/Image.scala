...
object Image:
  val heart_img: BufferedImage = Tools.scaleImage(Tools.loadImage("gui/heart.png"), 1.5, 1.5)
  val coins_img: BufferedImage = Tools.scaleImage(Tools.loadImage("gui/coins.png"), 1.5, 1.5)
  ...
  val skull_img: BufferedImage = Tools.scaleImage(Tools.loadImage("gui/skull.png"), 1.5, 1.5)
